...
from db_utils import PostQuery1

class ppSearchObject(Resource):

    def post(self):
        print("", request.get_json())
        # print("[0] :", request.get_json()['data'][0])

        value = request.get_json()
        print("val", value)

        PostQuery1("delete from searchlist;")
        print("data: ", value["data"])
        

        for i in value["data"] :
            print("print:", i)
            PostQuery1("insert into searchlist value ({i});", )
