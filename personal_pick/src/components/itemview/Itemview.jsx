    ...
    <div className='flex_row alldiv'>
        {itemDic.map((item) => (
            <div className='itemBox' key={item.idx}>
                <img src={item.cos_img_src} alt="" style={{width:60}}/>   
                <br/>
                <div className='rank_brand_name'>
                        ...
                        <div className='flex_col'>
                            ...
                            <div><span className='rank_cos_grade'>{item.grade }</span> 
                            <span className='rank_cos_grade_cnt'>   {"("+item.grade_count+")"}</span></div>
                        </div>
                        <div className='rank_cos_price'><span>{"정가 " + item.price + "원 / " + item.vol + "ml"}</span></div>
                        < br/>
